...
<!--Formulario para buscar listado de alumnos-->
<form action="lista_alumnos.php" method="post" enctype="multipart/form-data">
    <fieldset>
...
<?php
    ...
    echo "No tiene autorizaci&oacute;n para Tomar Asistencia";
}
