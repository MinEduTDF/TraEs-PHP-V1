...
//Llamo el SP para agregar un alumno que tengo en la BD
    ...
    @$sql = "CALL agregar_division ('".$descripcion."',".$activo.");";
    $res = mysql_query($sql);
    $rs = mysql_fetch_assoc($res);
    
    if ($rs["estado"] == "nuevo") {
        
        $cargado = "Se agrego una divisi&oacute;n nueva: ".$rs["descripcion"];
        
    } elseif ($rs["estado"] == "cargado") {
        $cargado = "Ya se encuentra registrada una divisi&oacute;n con esa descripci&oacute;n: ".$rs["descripcion"];
    }
