...
<?php
$row_c = mysql_fetch_row($combo_curso);

if ($row_c > 0){ 
    do { 
        echo "<tr>
                <td>".$row_c[1]."</td>
                <td align='center'><a href='modificar.php?id=".$row_c[0]."&maestro=curso'><img src='imgs/modificar.png' alt='Modificar'></a></td>
            </tr>";
    } while ($row_c = mysql_fetch_row($combo_curso));
}
?>
</table><br><br>
